...
const Login = () => {
  ...
  const loginUser = async (e) => {
    try {
      ...
      if (parsedCheck === 'login success') navigate('/');
  ...
  const signUserUp = async (e) => {
    try {
      ...
      // catch invalid inputs
      if (name === '' || email === '' || username === '' || password === '' || password !== password2) return;
        ...
        <>
          ...
          <main className='signup'>
            <form onSubmit={signUserUp}>
              ...
              <br />
              <span>Username: </span>
              <input ref={usernameField} onChange={checkExistence} id='username-input' type='text' />
              <br />
              <span>Password: </span>
              <input ref={passwordField} type='password' />
              <br />
