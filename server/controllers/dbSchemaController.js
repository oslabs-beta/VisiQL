...
dbSchemaController.getSchema = async (res, req, next) => {
try {
const queryStr = 'SELECT table_schema, table_name, ordinal_position as position, column_name, data_type, column_default as default_value FROM information_schema.columns WHERE table_schema NOT IN (\'information_schema\', \'pg_catalog\') AND table_name != \'pg_stat_statements\' ORDER BY table_schema, table_name, ordinal_position;';
